...
public class VTiger_purchaseOrder_TC34 extends BaseClass{
	
	@Test
	public void testCase34() throws FileNotFoundException, IOException, AWTException
	{
        ...
        pageNewPurchaseOrder.getEraseContactNameButton().click();
